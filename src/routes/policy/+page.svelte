<script lang="ts">
	const policyItems: Array<{ title: string; content: string }> = [
		...
		},
		{
			title: 'Data Sharing',
			content:
				'We do not sell your personal information. We may share data with service providers or for legal reasons.'
		},
		{
			title: 'Data Security',
			content:
				'We implement measures to protect your data, but no method of transmission is 100% secure.'
		},
		{
			title: 'Your Rights',
