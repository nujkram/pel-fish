		...
		<div class="flex items-center justify-between">
			<a href="/" class="flex ml-2 md:mr-24" style="text-decoration-line: none;">
				<img
					...
					alt="Flowbite Logo"
				/>
				<span class="text-xl font-semibold dark:text-white text-gray-900">PELFISH</span>
			</a>
			<div class="flex items-center">
				<div class="flex items-center ml-3">
					<div class="relative inline-block text-left">
						...
						<div
							class="absolute right-0 z-50 {isDropdownOpen
								? 'block'
								: 'hidden'} my-2 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
							role="menu"
