			...
			<div class="p-6">
				...
				<div class="mt-4">
					<form class="max-w-lg mx-auto" on:submit={handleSubmit}>
						...
						<div class="mb-4">
							<label for="confirm-password" class="block mb-2 font-bold text-gray-700"
					...
					{#if message}
						<div
							transition:fade
							class="flex items-center bg-{alertColor}-500 text-white text-sm font-bold px-4 py-3 mt-4 rounded-b"
							role="alert"
						>
							<svg
